...
class PrivateOpenOrdersElementResponseModel extends ResponseModel
{
    /**
     * @var string
     */
    ...
    /**
     * @var PrivateOpenOrdersElementDescrResponseModel
     */
    private $descr;
    ...
    /**
     * @return PrivateOpenOrdersElementDescrResponseModel
     */
    ...
    protected function hydrate(ArrayFinder $results, ArrayFinder $params)
    {
        ...
        $this->descr = new PrivateOpenOrdersElementDescrResponseModel(
